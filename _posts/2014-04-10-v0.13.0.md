...
We've also updated the [MahApps.Metro.Resources NuGet package](https://www.nuget.org/packages/MahApps.Metro.Resources/) with the [latest icons](http://modernuiicons.com/).
